...
/**
 * Created by Diana on 13/09/2015.
 */
/**
 * Translate
 *
...
public final class Translate extends MicrosoftTranslatorAPI {
     ...
     */
    public static void execute1(final String text, final Language from) throws Exception {
    ...
    public static String execute2(final String text, final Language to) throws Exception {
        //Run the basic service validations first
        validateServiceState(text);
        final String params =
                (apiKey != null ? PARAM_APP_ID + URLEncoder.encode(apiKey, ENCODING) : "")
